...
exports.reset = exports.getLocalStatus = exports.getRemotes = exports.getRemoteBranches = exports.getLocalBranches = exports.getCurentBranchName = void 0;
...
function getLocalBranches() {
    var raw = shelljs_1.default.exec('git branch', { silent: true }).toString().trimEnd();
...
function getRemoteBranches() {
    var raw = shelljs_1.default.exec('git branch -r', { silent: true }).toString().trimEnd();
    var branches = raw.split('\n');
    return branches.map(function (branchName) {
        if (/->/.test(branchName)) {
 ...
 */
function getRemotes() {
    var raw = shelljs_1.default.exec('git remote', { silent: true }).toString().trimEnd();
...
function getLocalStatus() {
    var raw = shelljs_1.default.exec('git status --porcelain', { silent: true }).toString().trimEnd();
