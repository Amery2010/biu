...
function deploy(env, dateTpl, version) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var tagName, _a, confirm, confirm_1;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    shelljs_1.default.echo(chalk_1.default.error("Biu: Unknown env " + env));
                    return [3 /*break*/, 8];
                ...
                case 7:
                    confirm_1 = _b.sent();
                    if (confirm_1.deployType === 'exit') {
                        shelljs_1.default.exit();
                    }
                    else {
                        deploy(confirm_1.deployType, dateTpl, version);
                    }
                    _b.label = 8;
