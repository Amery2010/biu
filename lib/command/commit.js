...
function commit(message, type, scope) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var commitMessage, localStatus, answers, choices_1, confirm, commitType;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (answers.confirm) {
                        ...
                        shelljs_1.default.echo(chalk_1.default.warning('Biu: please commit locally modified files or checkout first'));
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3:
                    shelljs_1.default.echo(chalk_1.default.green("Biu: current branch is ") + chalk_1.default.red(git_1.getCurentBranchName()));
                    choices_1 = [];
