...
var typeMap = {
    feature: locals_1.default.t('feature'),
    release: locals_1.default.t('release'),
    hotfix: locals_1.default.t('hotfix'),
};
var findType = function (desc) {
    ...
    throw new Error(locals_1.default.t('findTypeError'));
};
/**
 * 创建分支
 * @param target 目标分支名
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!name)
                        return [2 /*return*/, helper_1.handleError(locals_1.default.t('missingBranchName'))];
                    switch (type) {
                        case 'feature':
                            git_1.pullRemoteBranch('develop');
...
function finish(prefix, type, name) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var gitflow_1, gfType_1, localBranches, choices_1, answers;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    git_1.checkLocalStatus();
                ...
                case 2:
                    gitflow_1 = _a.sent();
                    gfType_1 = findType(gitflow_1.type);
                    localBranches = git_1.getLocalBranches();
                    choices_1 = [];
                    localBranches.forEach(function (branch) {
                        var branchPrefix = prefix[gfType_1];
                        if (new RegExp("^" + branchPrefix + "/").test(branch)) {
                            choices_1.push(branch.substring(branchPrefix.length + 1));
                        }
                    });
                ...
                case 3:
                    answers = _a.sent();
                    finish(prefix, gfType_1, answers.name);
                    _a.label = 4;
                ...
                case 1: return [4 /*yield*/, inquirer_1.prompt([
                        {
                            ...
                            choices: [locals_1.default.t('start'), locals_1.default.t('finish'), locals_1.default.t('init')],
                        },
                    ])];
                case 2:
                    answers = _a.sent();
                    switch (answers.type) {
                        case locals_1.default.t('start'):
                            return [2 /*return*/, start(prefix)];
                        case locals_1.default.t('finish'):
                            return [2 /*return*/, finish(prefix)];
                        case locals_1.default.t('init'):
