 ...
 * @param message 备注信息
 */
function pushTag(upstream, tagName, message) {
    ...
    if (!localBranches.includes('develop')) {
        ...
        if (remoteBranches.includes(upstream + "/develop")) {
            ...
            if (git_1.getCurentBranchName() !== 'master') {
                shelljs_1.default.exec("git checkout " + upstream + "/master");
            }
            shelljs_1.default.exec('git pull');
            shelljs_1.default.exec("git checkout -b develop " + upstream + "/master");
        }
 ...
 * @param name 分支名称
 */
function start(upstream, prefix, type, name) {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    switch (type) {
                        case 'feature':
                            git_1.pullRemoteBranch(upstream + "/develop");
                        ...
                        case 'release':
                            ...
                            break;
                        case 'hotfix':
                            git_1.pullRemoteBranch(upstream + "/master");
 ...
 * @param name 分支名称
 */
function finish(upstream, prefix, type, name) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    switch (type) {
                        ...
                        case 'hotfix':
                            ...
                            pushTag(upstream, "v" + helper_1.getProjectVersion(), prefix.hotfix + " " + name);
                ...
                case 3:
                    answers = _a.sent();
                    finish(upstream, prefix, gitflow_1.type, answers.name);
                    _a.label = 4;
 ...
 * @param prefix 分支前缀
 */
function gitflow(mode, upstream, prefix) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var answers;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    switch (answers.type) {
                        case 'start':
                            return [2 /*return*/, start(upstream, prefix)];
                        case 'finish':
                            return [2 /*return*/, finish(upstream, prefix)];
                        case 'init':
                            return [2 /*return*/, init(upstream)];
                        default:
                            break;
                    }
                    _a.label = 3;
