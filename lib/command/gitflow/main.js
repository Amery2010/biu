 ...
 * @param name 分支名称
 */
function start(upstream, perfix, type, name) {
 ...
 * @param prefix 分支前缀
 */
function gitflow(mode, upstream, perfix) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var answers;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    switch (answers.type) {
                        case 'start':
                            return [2 /*return*/, start(upstream, perfix)];
                        case 'finish':
                            return [2 /*return*/, finish(upstream, perfix)];
                        case 'init':
